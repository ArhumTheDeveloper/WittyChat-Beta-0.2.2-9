var AppProcess = (function () {
    ...
    async function setConnection(connid) {
        var connection = new RTCPeerConnection(iceConfigeration)
...
var MyApp = (function () {
    ...
    function addUser(other_user_id, connId) {
        var newDivId = $("#otherTemplate");
        newDivId = newDivId.attr("id", connId);
